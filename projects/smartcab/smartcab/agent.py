...
class LearningAgent(Agent):
    ...
    def build_state(self):
        ...
        # waypoint: None, foward, left, right
        # light: True (NS open); False (EW open)
        # oncoming: 
    ...
    def choose_action(self, state):
        ...
        # valid_actions = [None, 'forward', 'left', 'right']
            ...
            actions_maxQ = [action for action in self.Q[state].keys() if self.Q[state][action] == maxQ]
            action = actions_maxQ[random.randint(0, len(actions_maxQ)-1)]
        return action
    ...
    def learn(self, state, action, reward):
        ...
        self.createQ(state)
        self.createQ(self.build_state())
        if self.learning:
            #self.Q[state][action] = self.Q[state][action] + self.alpha*(reward + self.get_maxQ(self.build_state()) - self.Q[state][action])
